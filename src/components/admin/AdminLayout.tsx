...
const navItems: NavItem[] = [
  { label: 'Dashboard', icon: LayoutDashboard, path: '/admin', badge: '3' },
  { label: 'Honeypots', icon: Server, path: '/admin/honeypots', badge: '5' },
  { label: 'Decoy Services', icon: Puzzle, path: '/admin/decoy-services', badge: '8' },
  { label: 'Attack Events', icon: Swords, path: '/admin/attack-events', badge: '12' },
  { label: 'Payloads', icon: Binary, path: '/admin/payloads' },
  { label: 'Analytics', icon: BarChart3, path: '/admin/analytics' },
  { label: 'Alerts', icon: Bell, path: '/admin/alerts', badge: '2' },
  { label: 'Threat Intel', icon: Shield, path: '/admin/threat-intel' },
          ...
          {!collapsed ? (
            <div className="flex items-center gap-2 mb-3">
              ...
              <div className="overflow-hidden">
                <p className="text-xs text-[#f1f5f9] truncate">admin@deceivenet.io</p>
        ...
        >
          ...
          <header className="admin-content-offset fixed top-0 right-0 z-20 h-[56px] bg-[#1a1a1a] border-b border-[#2a2a2a] flex items-center px-4 gap-4">
            ...
            <div className="flex items-center gap-3 shrink-0">
              ...
              {/* User avatar */}
              <button className="flex items-center gap-1.5 p-1 rounded-md hover:bg-[#242424] transition-colors">
